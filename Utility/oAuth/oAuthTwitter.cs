...
namespace Utility
{
    namespace oAuth
    {
        public class oAuthTwitter : oAuthBase1a
        {
            ...
            public string ConsumerKey
            {
                get
                {
                    ...
                    {
                        _consumerKey = System.Configuration.ConfigurationManager.AppSettings["Twitter.consumerKey"];
                    }
                    return _consumerKey;
                }
            ...
            public string ConsumerSecret    
            {
                get
                {
                    ...
                    {
                        _consumerSecret = System.Configuration.ConfigurationManager.AppSettings["Twitter.consumerSecret"];
                    }
            ...
            public string AuthorizationLinkGet()
            {
                ...
                string response = oAuthWebRequest(Web.Method.POST, REQUEST_TOKEN, String.Empty);
            ...
            public void AccessTokenGet(string authToken, string oauthVerifier)
            {
                ...
                string response = oAuthWebRequest(Web.Method.GET, ACCESS_TOKEN, String.Empty);
